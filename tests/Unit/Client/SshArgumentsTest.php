 ...
 */
class SshArgumentsTest extends TestCase
{
    public function testImmutable()
    {
        $arguments1 = new SshArguments();
        ...
        $arguments6 = $arguments5->withDefaults((new SshArguments())->withFlags(['-S']));
    ...
    {
        $arguments = (new SshArguments())->withFlags(['-A'])->withOptions(['Option' => 'Value']);
        $defaults = (new SshArguments())->withFlags(['-F'])->withOptions(['Option' => 'Default']);
    ...
    {
        $arguments = (new SshArguments())->withFlags($flags)->withOptions($options);
    ...
    {
        $host = new Host('test', 'test.com');
        $arguments = (new SshArguments())->withMultiplexing($host);
    ...
    {
        $host = new Host('test', 'test.com');
        $arguments = (new SshArguments())->withOption('ControlPersist', '600')->withMultiplexing($host);
        $controlPath = $arguments->getOption('ControlPath');
    ...
    {
        $arguments = (new SshArguments())->withOption('ControlPersist', '600');
    ...
    {
        $arguments = (new SshArguments())->withFlags(['-A', '-p' => null, '-b' => 'value']);
